...
function setup() {
  // on charge le modèle
  classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/ojiBFTQgt//model.json");
...
function draw() {
  ...
  fill("#CF0062");
  ellipse(appleX, appleY + pixelSize / 1, pixelSize);
...
function keyPressed() {
  switch (keyCode) {
    ...
    case 40: // 40 à flèche du bas
      goDown();
      break;
      case 39: // 39 correspond à flèche de droite
      goRight();
      break;
      case 37: // 37 correspond à flèche de gauche
      goLeft();
      break;
  }
}
